...
##
golem::fill_desc(
  pkg_name = "optimalport", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
usethis::use_git_remote(
  name = "origin",
  url = "https://github.com/OskarAllerslev/OP.git"
)
